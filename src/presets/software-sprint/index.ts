...
export const TEMPLATES = {
  "bug.json": storedTemplate("bug", {
    ...
    actualResult: "TBD",
    acceptanceCriteria:
      "Bug is fixed, covered by validation, and ready for sprint review.",
    body: "## Reproduction\nTBD\n\n## Fix Notes\nTBD\n",
  }),
  "epic.json": storedTemplate("epic", {
    ...
    risk: "medium",
    acceptanceCriteria:
      "Epic has a clear outcome, scoped child work, and release target.",
    body:
      "## Objective\nTBD\n\n## Stakeholder\nTBD\n\n## Estimated Sprints\nTBD\n\n## Success Criteria\nTBD\n\n## Scope\nTBD\n",
  }),
  "feature.json": storedTemplate("feature", {
    ...
    confidence: "high",
    acceptanceCriteria:
      "Feature meets acceptance criteria, has tests, and is reviewed.",
